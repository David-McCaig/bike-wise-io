        ...
        <>
                  ...
                  <div className="sm:flex space-x-4 hidden">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="rounded-md px-3 py-2 text-md font-medium text-slate-600"
          ...
          <Disclosure.Panel className="sm:hidden">
            {user ? (
              <div className="space-y-1 px-2 pb-3 pt-2">
                {navigation.map((item) => (
                  <Disclosure.Button
                    ...
                    as="a"
                    href={item.href}
                    className="block text-slate-600 rounded-md px-3 py-2 text-base font-medium"
                    aria-current={item.current ? "page" : undefined}
                  >
                    {item.name}
                  </Disclosure.Button>
              ...
              <div className="ml-2">
                <Button className="h-8 px-2 bg-[#FAFAF9 text-slate-800 border border-slate-500">
                  <Image
                    className="mr-2"
                    src={GoogleLogo}
                    alt="Google logo"
